...
public class TitleScreen extends BorderPane {
    ...
    public TitleScreen(String name, int numPlayers, boolean saveable) throws FileNotFoundException {
        this.gameName = name;
    ...
    public void handleMultiplayer(String gameName){
        ...
        if (myGameParser.supportsMultiplayer()){
            myGameParser.updateJSONValue("playerCount", String.valueOf(playerNumber()));
        }
    }
}
