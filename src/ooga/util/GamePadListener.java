...
public class GamePadListener {
    ...
    private static final String LEFT_THUMBSTICK_RIGHT = "LEFT_THUMBSTICK_RIGHT";
    private static final String LEFT_THUMBSTICK_LEFT = "LEFT_THUMBSTICK_LEFT";
    private static final String LEFT_THUMBSTICK_UP = "LEFT_THUMBSTICK_UP";
    private static final String LEFT_THUMBSTICK_DOWN = "LEFT_THUMBSTICK_DOWN";
    private static final String RIGHT_THUMBSTICK_RIGHT = "RIGHT_THUMBSTICK_RIGHT";
    private static final String RIGHT_THUMBSTICK_LEFT = "RIGHT_THUMBSTICK_LEFT";
    private static final String RIGHT_THUMBSTICK_UP = "RIGHT_THUMBSTICK_UP";
    private static final String RIGHT_THUMBSTICK_DOWN = "RIGHT_THUMBSTICK_DOWN";
    private static final String A_BUTTON = "A_BUTTON";
    private static final String B_BUTTON = "B_BUTTON";
    private static final String X_BUTTON = "X_BUTTON";
    private static final String Y_BUTTON = "Y_BUTTON";
    private static final int MAX_RUMBLE = 65535;
    private static final int NO_RUMBLE = 0;
    private static final double THUMBSTICK_THRESHHOLD = 0.3;
